...
void load_validate_memory(hls::stream<ap_axis_plaic<32> > &toPl, hls::stream<ap_axis_plaic<32> > &frPl, vsi::device<int> &mem)
{
	...
	printf("%s: Running PLAIC and RDMAs, then validating data.\n", __FUNCTION__);
