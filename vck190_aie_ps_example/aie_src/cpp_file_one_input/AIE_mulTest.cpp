...
void AIE_mulTest(input_window_float *  restrict  A, output_window_float *  restrict  C) {
  uint64_t index;
...
{v8float  *store_temp_0 = (v8float*)((float*)get_wp_float(C,index));
   *store_temp_0 = as_v8float(aie::mul(aie::vector<float,8>(wide_load),aie::vector<float,8>((*(v8float *)vsi_aibe_vec_const_0))));}
;
#line 4 "/net/shared/kafi/AIE_mulTest/AIE_mulTest.cc"
