...
void stream_whileLoop_v2(int32_t * __restrict__ A, float * __restrict__ B,
   ...
   complex<int32_t> * __restrict complex_coeff_0 = (complex<int32_t> * __restrict__)coeff_0;
   complex<float> * __restrict complex_coeff_1 = (complex<float> * __restrict__)coeff_1;
